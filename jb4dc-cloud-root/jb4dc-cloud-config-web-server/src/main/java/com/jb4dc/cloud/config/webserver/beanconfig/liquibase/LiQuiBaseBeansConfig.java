package com.jb4dc.cloud.config.webserver.beanconfig.liquibase;
...
public class LiQuiBaseBeansConfig {
    ...
    public Liquibase liquibase(DataSource dataSource) throws JBuild4DCGenerallyException {
        ...
        try {
            ...
            liquibase = new Liquibase("liquibase/jb4dc-config-db-changelog.xml", new ClassLoaderResourceAccessor(), database);
