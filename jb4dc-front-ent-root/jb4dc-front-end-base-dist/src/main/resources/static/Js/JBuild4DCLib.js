...
var AjaxUtility = {
  ...
  Post: function Post(_url, sendData, func, caller, dataType, contentType, isAsync) {
  ...
  Get: function Get(_url, sendData, func, caller, dataType, isAsync) {
    var url = BaseUtility.BuildAction(_url);
  ...
  Delete: function Delete(_url, sendData, func, caller, dataType, contentType, isAsync) {
    var url = BaseUtility.BuildAction(_url);
