...
var DialogUtility = {
  ...
  Confirm: function Confirm(openerWindow, htmlMsg, okFn) {
    this.ConfirmConfig(openerWindow, htmlMsg, null, okFn);
  },
  ConfirmConfig: function ConfirmConfig(openerWindow, htmlMsg, config, okFn) {
